...
import { ClipboardList, Repeat, AlertTriangle, Lightbulb } from "lucide-react";
...
export default function HistoryPage() {
  ...
  const labels = { daily: "Dia a Dia", process: "Processo", bottleneck: "Gargalo", suggestion: "Sugestão" };
    ...
    <AppLayout>
      <div className="space-y-6 animate-slide-up">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {([["daily", myDaily.length], ["process", myProcesses.length], ["bottleneck", myBottlenecks.length], ["suggestion", mySuggestions.length]] as const).map(([type, count]) => (
