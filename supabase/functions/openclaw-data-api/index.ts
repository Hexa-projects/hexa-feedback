...
const TABLES: Record<string, { domain: string; description: string }> = {
  ...
  work_orders:            { domain: "ops",     description: "Ordens de serviço técnico" },
  work_order_activities:  { domain: "ops",     description: "Atividades/checklist das OS" },
  ...
  suggestions:            { domain: "ops",     description: "Sugestões de melhoria" },
  tool_mappings:          { domain: "ops",     description: "Mapeamento de ferramentas usadas" },
  ...
  webhook_events:         { domain: "meta",    description: "Eventos de webhook recebidos" },
  webhook_sources:        { domain: "meta",    description: "Fontes de webhook configuradas" },
};
